...
from answer import get_answer,get_num,set_num,get_answer # setnum, getnum 둘 다 사용해야 함 set+1, get이 2이면 end로 아니면 
import sys
...
window.mainloop()
# def res():
#     tutorial_answer_path="fold_db/tutorial_answer"
...
#         window.destroy()
#         # import tutorial
#         os.system('python ./fold_html/result_a.py')
#     def start():
#         window.destroy()
#         import end
